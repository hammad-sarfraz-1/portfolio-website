  ...
  return (
    <section id="youtube" className="youtube-section">
      <div className="container">
        ...
        <p className="section-subtitle">Follow my content and updates on YouTube 🎥</p>
            ...
            <div className="channel-card">
              <div className="channel-body">
                <p className="channel-description">
                  No YouTube channels are configured yet. Add channels in `portfolio.json` to display them here.
                </p>
              </div>
            </div>
          </div>
          ...
          <>
            ...
            <div className="youtube-stats">
              ...
              <div className="stat-item">
                <div className="stat-icon">📹</div>
                <div className="stat-info">
                  <span className="stat-value">Regular</span>
